...
Use NumPy’s np.var() applied across each row of subject columns.
"""
...
"""📈 8. Linear Regression Question
8. Can we predict a student’s Python score using their other skill scores, age, and location?
